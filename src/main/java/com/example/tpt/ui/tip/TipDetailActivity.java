...
public class TipDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setBackgroundDrawable(
                    new ColorDrawable(ContextCompat.getColor(this, R.color.primary_blue))
            );
    ...
    private void addContent(String title) {
        switch (title) {
            ...
            case "도서관 TIP":
                addText("(**Clicker 앱**)");
                // addImage(R.drawable.img_clicker); // 이미지가 있다면 추가
            ...
            case "학식 TIP":
                ...
                addText("(**잇츠미 앱**)");
                // addImage(R.drawable.img_itsme); // 이미지가 있다면 추가
            ...
            case "학생증 TIP":
                ...
                addText("-> 개인별 학사정보시스템에서 신청, 학과장 승인(학과장 승인 후 그 다음날 신청자료가 학생과로 송부됨)\n" +
                        ...
                        "-> 학생과에서 단대 및 학과를 통해 학생증 배부");
                addText("(**국립창원대학교 앱**)");
                // addImage(R.drawable.img_cwnu_app); // 이미지가 있다면 추가
                addText("3. 모바일 학생증\n" +
                        "-> 창원대학교앱에서 즉시 발급 가능하다.");
                break;
